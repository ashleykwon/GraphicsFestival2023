...
export const setupLights = () => {
    ...
    // laser lights
    let centerL = [-14, 1, 63]
    const laserL1 = new Laser(0x00ff00, 0.2, [centerL[0] + 2, centerL[1], centerL[2]]);
    const laserL2 = new Laser(0x00ff00, 0.2, [centerL[0], centerL[1], centerL[2] + 2]);
    const laserL3 = new Laser(0x00ff00, 0.2, [centerL[0] + 2, centerL[1], centerL[2] + 2]);
    const laserL4 = new Laser(0x00ff00, 0.2, [centerL[0], centerL[1], centerL[2]]);
    laserL1.setModeOn();
    laserL2.setModeOn();
    laserL3.setModeOn();
    laserL4.setModeOn();
    ...
    const laserLF1 = new Laser(0x00ff00, 0.2, [centerLF[0] + 2, centerLF[1], centerLF[2]]);
    const laserLF2 = new Laser(0x00ff00, 0.2, [centerLF[0], centerLF[1], centerLF[2] + 2]);
    const laserLF3 = new Laser(0x00ff00, 0.2, [centerLF[0] + 2, centerLF[1], centerLF[2] + 2]);
    const laserLF4 = new Laser(0x00ff00, 0.2, [centerLF[0], centerLF[1], centerLF[2]]);
    laserLF1.setModeOn();
    laserLF2.setModeOn();
    laserLF3.setModeOn();
    laserLF4.setModeOn();
    ...
    const laserR1 = new Laser(0x00ff00, 0.2, [centerR[0] + 2, centerR[1], centerR[2]]);
    const laserR2 = new Laser(0x00ff00, 0.2, [centerR[0], centerR[1], centerR[2] + 2]);
    const laserR3 = new Laser(0x00ff00, 0.2, [centerR[0] + 2, centerR[1], centerR[2] + 2]);
    const laserR4 = new Laser(0x00ff00, 0.2, [centerR[0], centerR[1], centerR[2]]);
    laserR1.setModeOn();
    laserR2.setModeOn();
    laserR3.setModeOn();
    laserR4.setModeOn();
    ...
    const laserRF1 = new Laser(0x00ff00, 0.2, [centerRF[0] + 2, centerRF[1], centerRF[2]]);
    const laserRF2 = new Laser(0x00ff00, 0.2, [centerRF[0], centerRF[1], centerRF[2] + 2]);
    const laserRF3 = new Laser(0x00ff00, 0.2, [centerRF[0] + 2, centerRF[1], centerRF[2] + 2]);
    const laserRF4 = new Laser(0x00ff00, 0.2, [centerRF[0], centerRF[1], centerRF[2]]);
    laserRF1.setModeOn();
    laserRF2.setModeOn();
    laserRF3.setModeOn();
    laserRF4.setModeOn();
